...
import com.example.uas_arli.databinding.ActivityContentBinding
import com.google.firebase.database.*
import com.google.firebase.storage.FirebaseStorage

class ContentActivity : AppCompatActivity() {
    private lateinit var BilliardRecyclerView: RecyclerView
    private lateinit var BilliardList:MutableList<fenomena_alam>
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(com.example.uas_arli.R.layout.activity_content)
        binding = ActivityContentBinding.inflate(layoutInflater)
        setContentView(binding.root)

        BilliardRecyclerView = findViewById(androidx.browser.R.id.end)
